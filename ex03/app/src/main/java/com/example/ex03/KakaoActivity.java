...
public class KakaoActivity extends AppCompatActivity {
    ...
    public void bookParser(String result){
        try{
            ...
            Log.d("size", String.valueOf(jArray.length()));
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            item.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    @SuppressLint("ViewHolder") View detail = View.inflate(KakaoActivity.this, R.layout.detail_book, null);
                    //타이틀들고오기
